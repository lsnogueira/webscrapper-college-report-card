...
(async () => {
  ...
  await getNotes(user, password);
})();

async function getNotes(user, password) {
  ...
  await page.waitForSelector('.i-boletim-modal > .i-boletim-table > tbody > .i-boletim-table-row > .td-small:nth-child(4)')
  await page.click('.i-boletim-modal > .i-boletim-table > tbody > .i-boletim-table-row > .td-small:nth-child(4)');

  nota = await page.evaluate(() => {
    return document.querySelector('.i-boletim-modal > .i-boletim-table > tbody > .i-boletim-table-row > .td-small:nth-child(4)').innerText;
  });
